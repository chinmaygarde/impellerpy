...
class Paragraph:
    ...
    def glyph_info_at_code_unit_index(self, code_unit_index: int) -> GlyphInfo: ...
    def glyph_info_at_paragraph_coordinate(self, x: float, y: float) -> GlyphInfo: ...
...
class DisplayListBuilder:
    ...
    def clip_path(self, path: Path, op: ClipOperation) -> DisplayListBuilder: ...
    def clip_rect(self, rect: Rect, op: ClipOperation) -> DisplayListBuilder: ...
    def clip_rounded_rect(self, rect: Rect, radii: RoundingRadii, op: ClipOperation) -> DisplayListBuilder: ...
    def draw_dashed_line(self, from_point: Point, to_point: Point, on_length: float, off_length: float, paint: Paint) -> DisplayListBuilder: ...
    def draw_display_list(self, dl: DisplayList, opacity: float) -> DisplayListBuilder: ...
    def draw_line(self, from_point: Point, to_point: Point, paint: Paint) -> DisplayListBuilder: ...
    def draw_oval(self, oval_bounds: Rect, paint: Paint) -> DisplayListBuilder: ...
    def draw_paint(self, paint: Paint) -> DisplayListBuilder: ...
    def draw_paragraph(self, paragraph: Paragraph, paint: Paint) -> DisplayListBuilder: ...
    def draw_shadow(self, path: Path, shadow_color: Color, elevation: float, occuluder_is_transparent: bool, device_pixel_ratio: float) -> DisplayListBuilder: ...
    def draw_path(self, path: Path, paint: Paint) -> DisplayListBuilder: ...
    def draw_rect(self, rect: Rect, paint: Paint) -> DisplayListBuilder: ...
    def draw_rounded_rect(self, rect: Rect, radii: RoundingRadii, paint: Paint) -> DisplayListBuilder: ...
    def draw_rounded_rect_difference(self, outer_rect: Rect, outer_radii: RoundingRadii, inner_rect: Rect, inner_radii: RoundingRadii, paint: Paint) -> DisplayListBuilder: ...
    def draw_texture(self, texture: Texture, point: Point, sampling: TextureSampling, paint: Paint) -> DisplayListBuilder: ...
    def draw_texture_rect(self, texture: Texture, src_rect: Rect, dst_rect: Rect, sampling: TextureSampling, paint: Paint) -> DisplayListBuilder: ...
    ...
    def save_layer(self, paint: Optional[Paint], backdrop: Optional[ImageFilter]) -> DisplayListBuilder: ...
...
class PathBuilder:
    ...
    def add_arc(self, start_degrees: float, end_degrees: float) -> PathBuilder: ...
    def add_oval(self, oval_bounds: Rect) -> PathBuilder: ...
    def add_rect(self, rect: Rect) -> PathBuilder: ...
    def add_rounded_rect(self, rect: Rect, radii: RoundingRadii) -> PathBuilder: ...
    def close(self) -> PathBuilder: ...
    def cubic_curve_to(self, cp1: Point, cp2: Point, end: Point) -> PathBuilder: ...

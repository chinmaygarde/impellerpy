...
class LineMetrics_:
    def unscaled_ascent(self, line: int) -> float: ...
    def ascent(self, line: int) -> float: ...
    def descent(self, line: int) -> float: ...
    def baseline(self, line: int) -> float: ...
    def is_hardbreak(self, line: int) -> bool: ...
    def width(self, line: int) -> float: ...
    def height(self, line: int) -> float: ...
    def left(self, line: int) -> float: ...
    def code_unit_start_index(self, line: int) -> int: ...
    def code_unit_end_index(self, line: int) -> int: ...
    def code_unit_end_index_excluding_whitespace(self, line: int) -> int: ...
    def code_unit_end_index_including_newline(self, line: int) -> int: ...
...
class ParagraphStyle_:
    def __init__(self) -> None: ...
    def set_background(self, paint: Paint_) -> ParagraphStyle_: ...
    def set_font_family(self, family: str) -> ParagraphStyle_: ...
    def set_font_size(self, size: float) -> ParagraphStyle_: ...
    def set_font_style(self, style: FontStyle_) -> ParagraphStyle_: ...
    def set_font_weight(self, weight: FontWeight_) -> ParagraphStyle_: ...
    def set_font_foreground(self, paint: Paint_) -> ParagraphStyle_: ...
    def set_height(self, height: float) -> ParagraphStyle_: ...
    def set_locale(self, locale: str) -> ParagraphStyle_: ...
    def set_max_lines(self, count: int) -> ParagraphStyle_: ...
    def set_text_alignment(self, align: TextAlignment_) -> ParagraphStyle_: ...
    def set_text_direction(
        self, direction: TextDirection_
    ) -> ParagraphStyle_: ...
...
class ParagraphBuilder_:
    ...
    def add_text(self, text: str) -> ParagraphBuilder_: ...
...
class DisplayListBuilder_:
    ...
    def draw_paragraph(
        self, paragraph: Paragraph_, point: Point_
    ) -> DisplayListBuilder_: ...
    def draw_shadow(
        self,
        path: Path_,
